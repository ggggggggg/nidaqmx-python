...
Refer to the `Getting Started with NI-DAQmx <https://www.ni.com/en-us/support/documentation/supplemental/06/getting-started-with-ni-daqmx--main-page.html>` page for more detailed documentation of the C and labview interfaces and higher level concepts such as Tasks. The python API follows the C API names relatilvey closely.
